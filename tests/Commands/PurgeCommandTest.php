...
class PurgeCommandTests extends TestCase
{
    ...
    public function it_writes_a_comment_if_there_are_no_models_configured()
    {
        ...
        $this->output_mock->shouldReceive('writeln')
                          ->once()
                          ->withArgs(
                              $this->checkVerbosity('<comment>There were no models configured to purge.</comment>')
                          )
                          ->andReturnNull();
    ...
    public function it_warns_on_models_in_the_config_that_does_not_exists()
    {
        ...
        $this->output_mock->shouldReceive('writeln')
                          ->once()
                          ->withArgs(
                              $this->checkVerbosity('<warning>The model [NoneExisting] was not found.</warning>')
                          )
                          ->andReturnNull();
    ...
    public function it_errors_on_models_in_the_config_that_does_not_have_forceDelete()
    {
        ...
        $this->output_mock->shouldReceive('writeln')
                          ...
                          ->withArgs(
                              $this->checkVerbosity(
                                  '<error>The model [NoForceDelete] does not support soft deleting.</error>'
                              )
                          )
                          ->andReturnNull();
    ...
    public function it_deletes_all_expired_records_for_models_with_soft_delete_when_not_configured_to_dispatch_events()
    {
        ...
        $this->output_mock->shouldReceive('writeln')
                          ...
                          ->withArgs(
                              $this->checkVerbosity(
                                  '<info>Deleting all the records in a single query statement.</info>'
                              )
                          )
                          ->andReturnNull();
        ...
        $this->output_mock->shouldReceive('writeln')
                          ...
                          ->withArgs(
                              $this->checkVerbosity(
                                  '<info>Purged 1 record(s) for ModelOne that was deleted before 14 days ago.</info>'
                              )
                          )
                          ->andReturnNull();
        ...
        $this->output_mock->shouldReceive('writeln')
                          ...
                          ->withArgs(
                              $this->checkVerbosity(
                                  '<info>Purged 0 record(s) for ModelTwo that was deleted before 30 days ago.</info>'
                              )
                          )
                          ->andReturnNull();
